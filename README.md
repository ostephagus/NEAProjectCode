...
## UI
The UI is written in C# using the WPF library and provides a GUI for the project. **TODO**

## Visualisation
The visualisation is written in C++ using OpenGL to manipulate individual pixels. It takes the data directly from the backend to display in a portion of the UI. **TODO**
